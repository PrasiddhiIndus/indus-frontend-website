...
const aboutData = {
 sectionTitle: "Products & Services",
  ...
  description:
    "Indus Fire Safety Pvt. Ltd. delivers comprehensive fire and safety solutions across India’s most demanding sectors. Our expertise spans the design and manufacturing of advanced fire trucks, development of high-performance safety systems, and deployment of certified manpower for industrial operations. Each solution is built on NFPA and ISO standards, ensuring reliability, compliance, and seamless emergency response across oil & gas, petrochemical, power, and infrastructure industries.",
  experience: {
    years: "32+",
    label: "years",
    text: "of proven excellence in fire safety innovation and engineering.",
  },
};
        ...
        >
          ...
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Services <span className={aboutData.highlightColor}>Products</span>
            </h2>
