                ...
                >
                    ...
                    <div className="w-full max-w-5xl flex flex-col items-center md:items-start text-center md:text-left">
                        ...
                        <p className="text-sm sm:text-base md:text-lg lg:text-xl font-light max-w-3xl leading-relaxed sm:leading-normal">
                            Custom-engineered fire and rescue vehicles built for rapid response and industrial reliability. Our high-performance trucks are designed to perform under the toughest emergency and hazardous-site conditions.
                            <br /><br />
                            Manufactured at our advanced facility in <strong>Chittorgarh, Rajasthan</strong>, we produce a full range of units — water and foam tenders, DCP/minitenders, rapid intervention vehicles, and specialized rescue units. Each vehicle features modern control systems, durable build quality, and compliance with national safety standards; custom configurations and AMC/crew-on-hire options are also available to meet your operational requirements.
                        </p>
                    </div>
                </motion.div>
            )}
