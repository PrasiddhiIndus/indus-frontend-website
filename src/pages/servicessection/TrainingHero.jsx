  ...
  return (
    <section className="relative h-screen w-full overflow-hidden select-none">
       <video
            ...
            >
                <source src="/assets/videos/servicestraining.mp4" type="video/mp4" />
            </video>
        ...
        >
          ...
          <div className="w-full max-w-5xl flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <p className="text-sm sm:text-base md:text-lg lg:text-xl font-light max-w-3xl leading-relaxed sm:leading-normal break-words">
              Indus Fire Safety delivers NFPA-certified training and professional development for fire safety, emergency response, and industrial operations across the <strong>Thar region</strong> and beyond. Our personnel are rigorously trained to handle complex environments, including refineries, chemical plants, and remote industrial sites.
              <br className="hidden sm:block" /><br className="hidden sm:block" />
              We also provide hands-on, practical training at our academies in <strong>Chittorgarh</strong> and <strong>Vadodara</strong>, equipping teams with essential skills, industry-recognized certifications, and the expertise needed to maintain a safer, fully compliant workplace.
            </p>
          </div>
        </motion.div>
      )}
