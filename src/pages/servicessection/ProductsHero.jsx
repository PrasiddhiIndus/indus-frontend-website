...
const ProductsHero = () => {
    ...
    return (
        <section className="relative h-screen w-full overflow-hidden select-none">
            ...
            >
                <source src="http://209.182.233.237/videos/servicesproducts.mp4" type="video/mp4" />
            </video>
                ...
                >
                    ...
                    <div className="w-full max-w-5xl flex flex-col items-center md:items-start text-center md:text-left">
                        ...
                        <p className="text-sm sm:text-base md:text-lg lg:text-xl font-light max-w-3xl leading-relaxed sm:leading-normal">
                            Indus Fire Safety delivers a complete range of fire and safety solutions—covering <strong>equipment manufacturing, system installation, and manpower deployment</strong> across critical industrial sectors. From custom-built fire trucks and advanced suppression systems to NFPA-certified training and on-site emergency support, our offerings are engineered to protect life, property, and operations in high-risk environments.
                            <br /><br />
                            With over <strong>32 years of experience</strong> and a nationwide presence, we partner with industries such as <strong>oil & gas, petrochemicals, power, ports, and infrastructure</strong> to design and maintain reliable, standards-compliant fire protection systems that ensure safety, readiness, and operational continuity.
                        </p>
                    </div>
                </motion.div>
            )}
